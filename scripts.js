...
{
    pergunta: "ffd",
    primeiraresposta: "dqwd",
    segundaresposta: "xs",
    terceiraresposta: "sac",
    quartaresposta: "dq", 
    respostacerta: "xs", 
...
{
    pergunta: "Quando o VTO foi criado ?",
    primeiraresposta: "2007",
    segundaresposta: "2008",
    terceiraresposta: "2009",
    quartaresposta: "2010", 
    respostacerta: "2007", 
...
{
    pergunta: "Quem viveu em web-cativeiro por 6 anos ?",
    primeiraresposta: "Angie",
    segundaresposta: "Felina",
    terceiraresposta: "Lya",
    quartaresposta: "Milena",
    respostacerta: "Milena"


},

{
    pergunta: "Quem foi o pior Staff que o VTO ja teve ?",
    primeiraresposta: `Sean`,
    segundaresposta: `Jessica"`,
    terceiraresposta: `Malevola`,
    quartaresposta: `Lya`, 
    respostacerta: `Lya`,
...
{
    pergunta: "Quem é o maior gado de toda a historia do xat VTO ?",
    primeiraresposta: "Okok da pastinha",
    segundaresposta: "R2,",
    terceiraresposta: "Lovinho",
    quartaresposta: "Paulo,Mod", 
    respostacerta: "Lovinho", 
          
},

{
    pergunta: "Dinheiro na mãoo... calcinha no chão, o dinheiro sumiu... ?",
    primeiraresposta: "A Calcinha subiu",
    segundaresposta: "A Calcinha sumiu",
    terceiraresposta: "O Nasc roubou",
    quartaresposta: "Nenhuma das anteriores", 
    respostacerta: "O Nasc roubou", 
          
},

{
    pergunta: "Maior corno de toda a historia do xat VTO ?",
    primeiraresposta: "Chocorno",
    segundaresposta: "Chocorno",
    terceiraresposta: "Chocorno",
    quartaresposta: "Eu", 
    respostacerta: "Eu", 
...
{
    pergunta: "Qual é a menina mais bonita atualmente do VTO ?",
    primeiraresposta: `AnjaLinda`,
    segundaresposta: `Creomilda`,
    terceiraresposta: `Coelha`,
    quartaresposta: `nenhuma das anteriores`, 
    respostacerta: `AnjaLinda`, 
          
},

{
    pergunta: "Qual é o rapaz mais bonito de todo o xat.com ?",
    primeiraresposta: "Ramses",
    segundaresposta: "Paulin",
    terceiraresposta: "GustavoCapoerista",
    quartaresposta: "Laio", 
    respostacerta: "GustavoCapoerista", 
          
},

{
    pergunta: "Se o VTO fosse a serie TODO MUNDO ODEIA O CRIS, quem seria o perigo ?",
    primeiraresposta: "Nasc",
    segundaresposta: "Bru",
    terceiraresposta: "WL",
    quartaresposta: "BrunoT", 
    respostacerta: "WL", 
          
},

{
    pergunta: "Quem Abre e fecha os portões do VTO ?",
    primeiraresposta: `Carlin`,
    segundaresposta: `Chain`,
    terceiraresposta: `Naomi`,
    quartaresposta: `Abey`, 
    respostacerta: "Chain", 
...
nivel.innerHTML = "Se burrice tivesse CPF... Tire print do seu resultado. &#128549"

}else if(pts >4 & pts <= 6){

nivel.innerHTML = "Mais ou menos em... Tire print do seu resultado. &#128533"

}else if(pts >6 & pts <= 9){

nivel.innerHTML = "Um bom desempenho, passou de ano. Tire print do seu resultado. &#128513"

}else if(pts == 10){

nivel.innerHTML = `Uau, voce realmente sabe da vida de todo mundo. Tire print do seu resultado. &#x1F62F`
